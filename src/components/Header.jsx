            ...
            <header className="p-4 dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <ul className="items-stretch hidden space-x-3 md:flex">
                        ...
                        <li className="flex">
                            <Link rel="noopener noreferrer" to="/shop" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Shop</Link>
                        </li>
                        <li className="flex">
                            <Link rel="noopener noreferrer" to="/cart" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Cart</Link>
                        </li>
                        <li className="flex">
